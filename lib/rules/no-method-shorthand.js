...
module.exports = {
  meta: {
    docs: {
      description: "Don't allow method shorthands in object literals",
  ...
  create(context) {
    ...
    const APPLY_TO_METHODS = true;
    const APPLY_TO_PROPS = false;
    const APPLY_NEVER = true;
    const APPLY_CONSISTENT = false;
    const APPLY_CONSISTENT_AS_NEEDED = false;
